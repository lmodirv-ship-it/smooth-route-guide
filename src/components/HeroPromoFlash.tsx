...
const HeroPromoFlash = () => (
  <>
    ...
    <motion.div
      ...
      className="hidden lg:block absolute left-2 xl:left-4 2xl:left-10 top-[6%] w-[280px] xl:w-[320px] 2xl:w-[370px] z-10"
    >
    ...
    <motion.div
      ...
      className="hidden lg:block absolute right-3 xl:right-6 2xl:right-14 top-[8%] w-[240px] xl:w-[280px] 2xl:w-[320px] z-10"
    >
