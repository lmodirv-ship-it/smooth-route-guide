...
const HeroPromoFlash = () => (
  <>
    ...
    <motion.div
      ...
      className="hidden lg:block absolute left-3 xl:left-6 2xl:left-14 top-[32%] -translate-y-1/2 w-[240px] xl:w-[280px] 2xl:w-[320px] z-10"
    >
    ...
    <motion.div
      ...
      className="hidden lg:block absolute right-3 xl:right-6 2xl:right-14 top-[38%] -translate-y-1/2 w-[240px] xl:w-[280px] 2xl:w-[320px] z-10"
    >
