...
export const LOCAL_ENGINES = [
  ...
  { id: "comfyui", label: "ComfyUI", domain: "github.com", install: "https://github.com/comfyanonymous/ComfyUI" },
  { id: "fooocus", label: "Fooocus", domain: "github.com", install: "https://github.com/lllyasviel/Fooocus" },
  { id: "invokeai", label: "InvokeAI", domain: "invoke.ai", install: "https://github.com/invoke-ai/InvokeAI" },
  { id: "sdnext", label: "SD.Next", domain: "github.com", install: "https://github.com/vladmandic/automatic" },
  { id: "piper", label: "Piper TTS", domain: "github.com", install: "https://github.com/rhasspy/piper" },
  { id: "coqui", label: "Coqui XTTS", domain: "coqui.ai", install: "https://github.com/coqui-ai/TTS" },
  { id: "openvoice", label: "OpenVoice", domain: "github.com", install: "https://github.com/myshell-ai/OpenVoice" },
  { id: "f5tts", label: "F5-TTS", domain: "github.com", install: "https://github.com/SWivid/F5-TTS" },
  { id: "melotts", label: "MeloTTS", domain: "github.com", install: "https://github.com/myshell-ai/MeloTTS" },
  { id: "bark", label: "Bark", domain: "suno.com", install: "https://github.com/suno-ai/bark" },
  { id: "webspeech", label: "Web Speech API", domain: "developer.mozilla.org", install: "https://developer.mozilla.org/docs/Web/API/Web_Speech_API" },
  { id: "whispercpp", label: "Whisper.cpp", domain: "github.com", install: "https://github.com/ggerganov/whisper.cpp" },
  { id: "fasterwhisper", label: "Faster-Whisper", domain: "github.com", install: "https://github.com/SYSTRAN/faster-whisper" },
  { id: "whisperx", label: "WhisperX", domain: "github.com", install: "https://github.com/m-bain/whisperX" },
  { id: "vosk", label: "Vosk", domain: "alphacephei.com", install: "https://alphacephei.com/vosk/" },
  { id: "sadtalker", label: "SadTalker", domain: "github.com", install: "https://github.com/OpenTalker/SadTalker" },
  { id: "wav2lip", label: "Wav2Lip", domain: "github.com", install: "https://github.com/Rudrabha/Wav2Lip" },
  { id: "ffmpeg", label: "FFmpeg", domain: "ffmpeg.org", install: "https://ffmpeg.org/download.html" },
  { id: "textgenwebui", label: "text-generation-webui", domain: "github.com", install: "https://github.com/oobabooga/text-generation-webui" },
  { id: "whisper", label: "Whisper Server", domain: "openai.com", install: "https://github.com/openai/whisper" },
];
