...
const AdminLayout = () => {
  ...
  const navItems = [
    ...
    // ─── نماذج الذكاء الاصطناعي وإدارة المنصة ───
    { path: "/admin/ai-models", icon: BrainCircuit, label: "🧠 نماذج الذكاء الاصطناعي" },
    ...
    { path: "/admin/licenses", icon: Shield, label: "🔐 التراخيص" },
    { path: "/admin/packages", icon: Package, label: "📦 الباقات" },
    { path: "/admin/invoices", icon: FileText, label: "🧮 الفواتير" },
    { path: "/admin/downloads", icon: Package, label: "⬇️ التنزيلات" },
    { path: "/admin/signup-requests", icon: UserCog, label: "📝 طلبات التسجيل" },
    { path: "/admin/monitoring", icon: Activity, label: "📡 المراقبة" },
    { path: "/admin/audit-log", icon: FileCheck, label: "🗒️ سجل الإجراءات" },
