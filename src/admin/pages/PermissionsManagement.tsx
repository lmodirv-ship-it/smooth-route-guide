                ...
                {selectedRole ? (
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between"><span className="text-muted-foreground">الحالة:</span>{roleIsActive(selectedRole) ? <Badge className="bg-green-500/15 text-green-600 border-green-500/30 text-xs">مفعّل</Badge> : <Badge variant="destructive" className="text-xs">معطّل</Badge>}</div>
